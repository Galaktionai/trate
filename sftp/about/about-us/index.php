...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "banner", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"IBLOCK_TYPE" => "aboutus",	// Тип информационного блока (используется только для проверки)
		...
		<div class="information">
                ...
                <?$APPLICATION->IncludeComponent(
                  ...
                  Array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/about/about-us/about-us-title.php"
                  )
                );?>
            </h3>
						<p>
                <?$APPLICATION->IncludeComponent(
                  ...
                  Array(
                    ...
                    "AREA_FILE_SUFFIX" => "inc",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/about/about-us/about-us-p.php"
                  )
                );?>
            </p>
				</div>
...
<section class="youtube">
    <iframe width="100%" height="100%" src="https://www.youtube.com/embed/AFPLRIdn1pk?si=oq8nJ4WoeiI7kect" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</section>
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "advantages", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		...
		"SORT_ORDER2" => "ASC",	// Направление для второй сортировки новостей
		"STRICT_SECTION_CHECK" => "N",	// Строгая проверка раздела для показа списка
		"COMPONENT_TEMPLATE" => "resmile-advantages"
	),
	false
);?>
		...
		<div class="information">
                ...
                <?$APPLICATION->IncludeComponent(
                  ...
                  Array(
                    ...
                    "AREA_FILE_SUFFIX" => "inc",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/about/about-us/about-us-title-2.php"
                  )
                );?>
            </h3>
						<p>
                <?$APPLICATION->IncludeComponent(
                  ...
                  Array(
                    ...
                    "AREA_FILE_SUFFIX" => "inc",
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/about/about-us/about-us-p-2.php"
                  )
                );?>
            </p>
				</div>
...
<?$APPLICATION->IncludeComponent("bitrix:news.list", "sertefikats-slider", Array(
	"ACTIVE_DATE_FORMAT" => "d.m.Y",	// Формат показа даты
		"ADD_SECTIONS_CHAIN" => "N",	// Включать раздел в цепочку навигации
		"AJAX_MODE" => "N",	// Включить режим AJAX
		"AJAX_OPTION_ADDITIONAL" => "",	// Дополнительный идентификатор
