...
if($_SERVER["REQUEST_METHOD"] == "POST" && $_POST["submit"] <> '' && (!isset($_POST["PARAMS_HASH"]) || $arResult["PARAMS_HASH"] === $_POST["PARAMS_HASH"]))
{
	...
	if(check_bitrix_sessid())
	{
		if(empty($arParams["REQUIRED_FIELDS"]) || !in_array("NONE", $arParams["REQUIRED_FIELDS"]))
		{
			...
			if((empty($arParams["REQUIRED_FIELDS"]) || in_array("LETTER_SUBJECT", $arParams["REQUIRED_FIELDS"])) && empty($_POST["LETTER_SUBJECT"]))
				$arResult["ERROR_MESSAGE"][] = GetMessage("MF_REQ_LETTER_SUBJECT");
		}
		...
		$arResult["LETTER_SUBJECT"] = htmlspecialcharsbx($_POST["LETTER_SUBJECT"]);
	}
	else
