...
//        echo "</pre>";
        ...
        <section class="s-rec">
            ...
            <div class="container-main-st">
                <div class="rec-a">
                    <? foreach ($arResult['ITEMS'] as $item): ?>
                        <a href="<?=$item['DETAIL_PAGE_URL']?>" id="w-node-c5bb2710-9c3f-e6c9-7cde-ce1873daa3bc-11bd7221"
                           data-w-id="c5bb2710-9c3f-e6c9-7cde-ce1873daa3bc" class="reb-box w-inline-block">
                            <div id="w-node-c5bb2710-9c3f-e6c9-7cde-ce1873daa3bd-11bd7221" class="rec-b"><img
                                        src="<?= $item["PREVIEW_PICTURE"]["SRC"] ?>" loading="lazy"
                                        alt=""
                                        class="rec-img"></div>
                            <div class="rec-t"><?= $item['NAME'] ?></div>
                        </a>
                    <? endforeach; ?>
                </div>
            </div>
