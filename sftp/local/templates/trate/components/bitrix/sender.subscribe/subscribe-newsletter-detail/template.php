...
?>
<div class="keys_detail__subskribe_wrap" id="sender-subscribe">
<?
...
?>
	...
	<script>
		(function () {
			...
			<span class="keys_detail__subskribe_title">Подписаться на рассылку</span>
			<span class="keys_detail__subskribe_p">Оставайтесь в курсе последних событий и новостей</span>
			<form class="keys_detail__subskribe_form" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
				<?=bitrix_sessid_post()?>
				<input type="hidden" name="sender_subscription" value="add">

				<input class="keys_detail__subskribe_form_email" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
				...
				<button class="keys_detail__subskribe_form_btn" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
			</form>
<?
$frame->beginStub();
?>
	...
	<script>
		(function () {
			...
			<form class="keys_detail__subskribe_form" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
				...
				<input class="keys_detail__subskribe_form_email" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
