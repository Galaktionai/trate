...
?>
<section class="subscribe_on_newsletter" id="sender-subscribe">
<?
...
?>
	...
	<div class="container">
		<div class="subscribe_on_newsletter__wrapper">
			<span class="subscribe_on_newsletter__title">Подписаться на рассылку</span>
			<span class="subscribe_on_newsletter__pre">Оставайтесь в курсе последних событий и новостей</span>
			<form class="subscribe_on_newsletter__wrapper__form" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
				<?=bitrix_sessid_post()?>
				<input type="hidden" name="sender_subscription" value="add">

				<input class="subscribe_on_newsletter__email" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
				...
				<button class="subscribe_on_newsletter__submit" id="bx_subscribe_btn_<?=$buttonId?>"><span><?=GetMessage("subscr_form_button")?></span></button>
			</form>
		</div>
	</div>
<?
	...
	<div class="container">
		<div class="subscribe_on_newsletter__wrapper">
			...
			<form class="subscribe_on_newsletter__wrapper__form" id="bx_subscribe_subform_<?=$buttonId?>" role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>">
				...
				<input class="subscribe_on_newsletter__email" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
