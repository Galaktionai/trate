...
<!--	<div class="col-md-3 col-sm-4 col-sm-push-8 col-md-push-9--><?php //=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' hidden-xs' : '')?><!--">-->
<!--		--><?// if ($isFilter): ?>
...
<!--	</div>-->
<?//endif?>
<!--<div class="--><?php //=(($isFilter || $isSidebar) ? "col-md-9 col-sm-8 col-sm-pull-4 col-md-pull-3" : "col-xs-12")?><!--">-->
<!--	<div class="row">-->
<!--		<div class="col-xs-12">-->
<!--			--><?//
...
<!--								--><?php //=($arParams['GIFTS_SECTION_LIST_BLOCK_TITLE'] ?: \Bitrix\Main\Localization\Loc::getMessage('CT_GIFTS_SECTION_LIST_BLOCK_TITLE_DEFAULT'))?>
<!--							</div>-->
<!--							--><?//
//						}
//
...
<!--						<div class="catalog-block-header" data-entity="header" data-showed="false" style="display: none; opacity: 0;">-->
<!--							--><?php //=GetMessage('CATALOG_PERSONAL_RECOM')?>
<!--						</div>-->
<!--						--><?//
//						$APPLICATION->IncludeComponent(
//							"bitrix:catalog.section",
